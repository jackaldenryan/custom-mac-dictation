...
expect(PunctuationPolicy.match(normalized: "open the parentheses", modes: [:]) == .typeCharacter("("), "open the parentheses")
expect(PunctuationPolicy.match(normalized: "closeparentheses", modes: [:]) == .typeCharacter(")"), "glued close parentheses")
expect(PunctuationPolicy.match(normalized: "closed parentheses", modes: [:]) == .typeCharacter(")"), "closed parentheses")
...
expect(PunctuationPolicy.match(normalized: "open square square bracket", modes: [:]) == .typeCharacter("["), "repeat square")
expect(PunctuationPolicy.match(normalized: "open square bracket", modes: [:]) == .typeCharacter("["), "square bracket")
expect(PunctuationPolicy.match(normalized: "open curly brace", modes: [:]) == .typeCharacter("{"), "curly brace")
expect(PunctuationPolicy.match(normalized: "close curly brace", modes: [:]) == .typeCharacter("}"), "close curly")
expect(PunctuationPolicy.match(normalized: "close square bracket", modes: [:]) == .typeCharacter("]"), "close square")
expect(PunctuationPolicy.looksLikePunctuation("open parentheses"), "open paren is punctuation")
expect(PunctuationPolicy.match(normalized: "open open parens", modes: [:]) == .typeCharacter("("), "repeat open parens")
expect(PunctuationPolicy.matchRawCharacter(")") == ")", "raw close paren")
expect(PunctuationPolicy.matchRawCharacter("(") == "(", "raw open paren")
expect(PunctuationPolicy.matchRawCharacter(".") == ".", "raw period")
